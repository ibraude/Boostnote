...
const ToggleDirectionButton = ({ onClick, editorDirection }) => (
  <div styleName="control-toggleModeButton">
    <div
      styleName={editorDirection ? "active" : undefined}
      onClick={() => onClick()}
    >
      <img
        src={!editorDirection ? "../resources/icon/icon-left-to-right.svg" : ""}
      />
    </div>
    <div
      styleName={!editorDirection ? "active" : undefined}
    ...
    >
      <img
        src={!editorDirection ? "" : "../resources/icon/icon-right-to-left.svg"}
      />
    </div>
